use specs::prelude::*;
use specs::saveload::{
    SimpleMarker, SimpleMarkerAllocator, SerializeComponents,
...
pub fn load_game(ecs: &mut World) {
    ...
    let mut de = serde_json::Deserializer::from_str(&data);
    {
        ...
        deserialize_individually!(
           ecs, de, data, Position, Renderable, Player, Viewshed,
...
pub fn save_game(ecs : &mut World) {
    ...
    // Actually serialize
    {
       ...
       serialize_individually!(
           ecs, serializer, data, Position, Renderable, Player, Viewshed,
           Monster, Name, BlocksTile, CombatStats, SufferDamage, WantsToMelee,
           Item, Consumable, Ranged, InflictsDamage, AreaOfEffect, Confusion,
           ProvidesHealing, InBackpack, WantsToPickupItem, WantsToUseItem,
           WantsToDropItem, SerializationHelper
